...
<body>
    <div class="container">
        <div class="card p-6 p-lg-10 space-y-4">
            ...
            <p>
                Miło nam poinformować, że właśnie wygrałeś/aś wycieczkę po kawę dla: <strong> {{ $mailData['fullname'] }} </strong> <br>
                Kawka z ekspresu, który stoi w kuchni. Losujący wybrał: <br>
                <strong> Rodzaj kawy: </strong> {{ $mailData['type'] }} <br>
                <strong> Pojemność: </strong> {{ $mailData['capacity'] }}
            </p>
        </div>
